...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(loaded, 'loaded', 'src/gulp-tasks-core.js');

  __REACT_HOT_LOADER__.register(coreTasks, 'coreTasks', 'src/gulp-tasks-core.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/gulp-tasks-core.js');
}();
